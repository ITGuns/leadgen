...
export async function fanOutCities(states: string[], opts?: { cityList?: string[] | null }): Promise<City[]> {
  const floor = await getSetting<number>("cityPopulationFloor", defaults.cityPopulationFloor);
